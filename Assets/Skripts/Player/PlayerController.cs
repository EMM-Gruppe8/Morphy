    ...
    protected override void Update()
    {
        ...
        if (controlEnabled)
        {
            if (Input.acceleration.x >= 0.03 || Input.acceleration.x <= -0.03)
            {
                ...
                //speed value will be positive when going to the right, and negative when going to the left
                //so we use Mathf.Abs() to make it a positive value always
            ...
            if (jumpState == JumpState.Grounded && Input.acceleration.z >= 0.15)
            {
                ...
                animator.SetBool("isJumping", true); //animation for jumping
            }
    ...
    void UpdateJumpState()
    {
        ...
        switch (jumpState)
        {
            ...
            case JumpState.Landed:
                ...
                animator.SetBool("isJumping", false); //stop animation for jumping
                break;
        }
    }
